...
(0, node_test_1.describe)('UserDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UserDataScraperSDK({
    ...
    (0, node_test_1.test)('direct-list-user_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_data', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.USER_DATA_SCRAPER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UserDataScraperSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['USER_DATA_SCRAPER_TEST_USER_DATA_ENTID'];
    ...
    const client = new __1.UserDataScraperSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UserDataDirect.test.js.map