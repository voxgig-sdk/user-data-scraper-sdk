...
function envOverride(m) {
    if ('TRUE' === process.env.USER_DATA_SCRAPER_TEST_LIVE ||
        'TRUE' === process.env.USER_DATA_SCRAPER_TEST_OVERRIDE) {
    ...
    m.USER_DATA_SCRAPER_TEST_EXPLAIN = process.env.USER_DATA_SCRAPER_TEST_EXPLAIN || m.USER_DATA_SCRAPER_TEST_EXPLAIN;
    return m;
}
