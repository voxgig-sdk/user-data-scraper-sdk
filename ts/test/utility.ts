...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.USERDATASCRAPER_TEST_LIVE ||
    'TRUE' === process.env.USERDATASCRAPER_TEST_OVERRIDE
  ) {
  ...
  m.USERDATASCRAPER_TEST_EXPLAIN = process.env.USERDATASCRAPER_TEST_EXPLAIN || m.USERDATASCRAPER_TEST_EXPLAIN
