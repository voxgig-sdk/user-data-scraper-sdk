...
// UserDataScraper SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UserDataScraperSDK::test)
...
{
    private const SDK_CLASS = 'UserDataScraperSDK';
    ...
    private const SDK_BASE = 'userdatascraper_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../userdatascraper_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
