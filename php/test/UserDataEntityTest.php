...
class UserDataEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = UserDataScraperSDK::test($seed, null);
        $seen = iterator_to_array($base->UserData(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->UserData(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set USER_DATA_SCRAPER_TEST_USER_DATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function user_data_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("USER_DATA_SCRAPER_TEST_USER_DATA_ENTID");
