...
// UserDataScraper SDK utility: result_basic

class UserDataScraperResultBasic
{
    public static function call(UserDataScraperContext $ctx): ?UserDataScraperResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UserDataScraperError) ? $result->err->msg : (string)$result->err;
