...
// UserDataScraper SDK utility: graphql
//
...
class UserDataScraperGraphql
{
    ...
    // equivalent.
    public static function body(UserDataScraperContext $ctx): mixed
    {
    ...
    public static function errors(UserDataScraperContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
