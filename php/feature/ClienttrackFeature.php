...
// UserDataScraper SDK clienttrack feature
...
class UserDataScraperClienttrackFeature extends UserDataScraperBaseFeature
{
    ...
    public function PostConstruct(UserDataScraperContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UserDataScraper-SDK';
