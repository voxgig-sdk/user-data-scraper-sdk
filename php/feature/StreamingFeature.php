...
// UserDataScraper SDK streaming feature
...
class UserDataScraperStreamingFeature extends UserDataScraperBaseFeature
{
    ...
    private function _iterate(UserDataScraperResult $result): \Generator
    {
    ...
    private function _streamable(UserDataScraperContext $ctx): bool
    {
