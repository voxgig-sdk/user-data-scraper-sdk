...
// UserDataScraper SDK timeout feature
...
class UserDataScraperTimeoutFeature extends UserDataScraperBaseFeature
{
    ...
    private function _with_timeout(UserDataScraperContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UserDataScraperContext $_ctx, float $ms): void
    {
        $client = $this->client;
