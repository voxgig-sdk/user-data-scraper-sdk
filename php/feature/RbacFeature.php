...
// UserDataScraper SDK rbac feature
...
class UserDataScraperRbacFeature extends UserDataScraperBaseFeature
{
    ...
    private function _required(UserDataScraperContext $ctx): ?string
    {
    ...
    private function _reject(UserDataScraperContext $ctx, string $required): void
    {
    ...
    private function _track(UserDataScraperContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
