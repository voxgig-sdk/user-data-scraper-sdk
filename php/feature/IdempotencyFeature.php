...
// UserDataScraper SDK idempotency feature
...
class UserDataScraperIdempotencyFeature extends UserDataScraperBaseFeature
{
    ...
    private function _mutating(UserDataScraperContext $ctx): bool
    {
