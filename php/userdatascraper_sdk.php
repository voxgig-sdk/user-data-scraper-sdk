...
class UserDataScraperSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UserDataScraperHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UserDataScraperHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UserDataScraperFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UserDataScraperFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UserDataScraperUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UserDataScraperHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UserDataScraperHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UserDataScraperHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UserDataScraperError($op . "_allow",
                "UserDataScraperSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UserDataScraperHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UserDataScraperError("graphql_error",
                "UserDataScraperSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function UserData($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_user_data === null) {
                $this->_user_data = new UserDataEntity($this, null);
            }
            return $this->_user_data;
        }
        return new UserDataEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UserDataScraperSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
