// Command UserDataScraper-mcp is an MCP server exposing the UserDataScraper
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UserDataScraper_list  — list records of an entity
//	UserDataScraper_load  — load a single record of an entity
//
