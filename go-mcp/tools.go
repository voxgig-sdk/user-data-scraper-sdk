...
type Args struct {
	Entity string         `json:"entity" jsonschema:"user_data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UserDataScraperSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "user-data-scraper_list",
		Description: "List records from UserDataScraper. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "user-data-scraper_load",
		Description: "Load a single record from UserDataScraper. " +
...
func runOp(client *sdk.UserDataScraperSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UserDataScraperSDK, name string) (sdk.UserDataScraperEntity, error) {
	switch strings.ToLower(name) {
	case "user_data":
		return client.UserData(nil), nil
