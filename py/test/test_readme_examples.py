# UserDataScraper SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UserDataScraperSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UserDataScraperSDK(...) and UserDataScraperSDK.test(...) become
#      UserDataScraperSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "userdatascraper_sdk"
_SDK_CLASS = "UserDataScraperSDK"
