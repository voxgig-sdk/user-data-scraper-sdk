...
from userdatascraper_sdk.utility import register

# Load features
from userdatascraper_sdk.feature.base_feature import UserDataScraperBaseFeature
from userdatascraper_sdk.features import _has_feature, _make_feature
...
class UserDataScraperSDK:
    ...
    def get_utility(self):
        return UserDataScraperUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UserDataScraperSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def UserData(self, data=None) -> "UserDataEntity":
        ...
        from userdatascraper_sdk.entity.user_data_entity import UserDataEntity
