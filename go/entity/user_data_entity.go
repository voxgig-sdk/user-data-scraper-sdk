...
import (
	...
	vs "github.com/voxgig-sdk/user-data-scraper-sdk/go/utility/struct"
)

type UserDataEntity struct {
	name    string
	client  *core.UserDataScraperSDK
...
func NewUserDataEntity(client *core.UserDataScraperSDK, entopts map[string]any) *UserDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserDataEntity) GetName() string { return e.name }
...
func (e *UserDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserDataEntity) Deleted() bool {
	return e.deleted
}


func (e *UserDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserDataEntity(e.client, opts)
}

func (e *UserDataEntity) Data(args ...any) any {
...
func (e *UserDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserDataEntity) DataTyped(data ...UserData) UserData {
	if len(data) > 0 {
		return typedFrom[UserData](e.Data(asMap(data[0])))
	}
	return typedFrom[UserData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserData (all fields
// optional at the wire level).
func (e *UserDataEntity) MatchTyped(match ...UserData) UserData {
	if len(match) > 0 {
		return typedFrom[UserData](e.Match(asMap(match[0])))
	}
	return typedFrom[UserData](e.Match())
}
...
func (e *UserDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UserDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserDataListMatch and returns []UserData. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UserDataEntity) ListTyped(reqmatch UserDataListMatch, ctrl map[string]any) ([]UserData, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[UserData](res), nil
}



func (e *UserDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
