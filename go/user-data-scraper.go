...
// instead of `sdk.NewUserDataScraperSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *UserDataScraperSDK  { return NewUserDataScraperSDK(nil) }
func Test() *UserDataScraperSDK { return TestSDK(nil, nil) }
