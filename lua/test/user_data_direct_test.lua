...
describe("UserDataDirect", function()
  it("should direct-list-user_data", function()
    local setup = user_data_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_data", setup.live and "live" or "unit")
...
function user_data_direct_setup(mockres)
