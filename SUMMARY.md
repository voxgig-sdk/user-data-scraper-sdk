...
Results: Successful response with user data.
...
| --- | --- | --- | --- |
| UserData | `list` | `GET /public` | See reference |

## Connect to the API

- Production server: `https://leakcheck.net/api`
...
- `user-data-scraper_list`: List records for an entity. Supported entities: `user_data`.
- `user-data-scraper_load`: Load one record for an entity. No active entity supports this operation.
