...
from projectname_sdk.core.control import UserDataScraperControl
...
class UserDataScraperContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UserDataScraperControl()
        ...
        if isinstance(sp, UserDataScraperSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UserDataScraperResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UserDataScraperResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return UserDataScraperOperation({})
    ...
    def make_error(self, code, msg):
        return UserDataScraperError(code, msg, self)
