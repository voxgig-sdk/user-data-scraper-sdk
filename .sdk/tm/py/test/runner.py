...
class UserDataScraperTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UserDataScraperTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UserDataScraperTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UserDataScraperTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
