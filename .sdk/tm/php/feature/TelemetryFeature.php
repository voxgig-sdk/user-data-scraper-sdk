...
// UserDataScraper SDK telemetry feature
...
class UserDataScraperTelemetryFeature extends UserDataScraperBaseFeature
{
    ...
    private function _close(UserDataScraperContext $ctx, bool $ok): void
    {
