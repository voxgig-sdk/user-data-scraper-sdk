...
// UserDataScraper SDK audit feature
...
class UserDataScraperAuditFeature extends UserDataScraperBaseFeature
{
    ...
    private function _emit(UserDataScraperContext $ctx, string $outcome): void
    {
