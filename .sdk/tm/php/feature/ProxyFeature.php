...
// UserDataScraper SDK proxy feature
...
class UserDataScraperProxyFeature extends UserDataScraperBaseFeature
{
    ...
    public function init(UserDataScraperContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UserDataScraperContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
