...
// UserDataScraper SDK metrics feature
...
class UserDataScraperMetricsFeature extends UserDataScraperBaseFeature
{
    ...
    private function _record(UserDataScraperContext $ctx, bool $ok): void
    {
