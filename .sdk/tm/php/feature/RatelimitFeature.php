...
// UserDataScraper SDK ratelimit feature
...
class UserDataScraperRatelimitFeature extends UserDataScraperBaseFeature
{
    ...
    private function _acquire(UserDataScraperContext $ctx): void
    {
    ...
    private function _track(UserDataScraperContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
