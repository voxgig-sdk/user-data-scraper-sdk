...
// UserDataScraper SDK cache feature
...
class UserDataScraperCacheFeature extends UserDataScraperBaseFeature
{
    ...
    private function _through(UserDataScraperContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
