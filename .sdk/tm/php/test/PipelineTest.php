...
// UserDataScraper SDK pipeline test
//
...
{
    private static function utility(): UserDataScraperUtility
    {
        return new UserDataScraperUtility();
    }
    ...
    private static function ctx(array $over = []): UserDataScraperContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UserDataScraperContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UserDataScraperOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UserDataScraperError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UserDataScraperOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UserDataScraperMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UserDataScraperOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UserDataScraperMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UserDataScraperOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UserDataScraperMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UserDataScraperSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UserDataScraperMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UserDataScraperResponse([]),
            'result' => new UserDataScraperResult([]),
        ]);
        [, $err] = UserDataScraperMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec([]),
            'response' => null,
            'result' => new UserDataScraperResult([]),
        ]);
        [, $err] = UserDataScraperMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec(['step' => 's']),
            'response' => new UserDataScraperResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UserDataScraperResult([]),
        ]);
        [, $err] = UserDataScraperMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec(['step' => 's']),
            'response' => new UserDataScraperResponse(self::resp(200, ['v' => 1])),
            'result' => new UserDataScraperResult([]),
        ]);
        [, $err] = UserDataScraperMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec(['step' => 's']),
            'response' => new UserDataScraperResponse(self::resp(200, ['v' => 2])),
            'result' => new UserDataScraperResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UserDataScraperMakeResponse::call($ctx);
    ...
    {
        $preset = new UserDataScraperResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec([]),
            'response' => new UserDataScraperResponse([]),
            'result' => new UserDataScraperResult([]),
        ...
        [$got, $err] = UserDataScraperMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UserDataScraperResult([])]);
        [, $err] = UserDataScraperMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UserDataScraperSpec([]), 'result' => null]);
        [, $err] = UserDataScraperMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UserDataScraperSpec(['step' => 's']),
            'result' => new UserDataScraperResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UserDataScraperOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UserDataScraperMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UserDataScraperSpec(['step' => 's']),
            'result' => new UserDataScraperResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UserDataScraperOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UserDataScraperMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UserDataScraperResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UserDataScraperSpec([]),
            'result' => new UserDataScraperResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UserDataScraperMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UserDataScraperMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UserDataScraperError('boom', 'boom');
        $utility->fetcher = function (UserDataScraperContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UserDataScraperSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UserDataScraperMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UserDataScraperContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UserDataScraperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UserDataScraperResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UserDataScraperMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UserDataScraperContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UserDataScraperSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UserDataScraperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UserDataScraperResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UserDataScraperSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UserDataScraperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UserDataScraperMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UserDataScraperMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UserDataScraperResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UserDataScraperDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UserDataScraperResult(['ok' => false])]);
        $this->expectException(UserDataScraperError::class);
        UserDataScraperDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UserDataScraperResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UserDataScraperMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UserDataScraperMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UserDataScraperBaseFeature();
        $b = new UserDataScraperBaseFeature();
        UserDataScraperFeatureAdd::call($ctx, $a);
        UserDataScraperFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UserDataScraperBaseFeature
    {
        $f = new UserDataScraperBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UserDataScraperFeatureAdd::call($ctx, self::named_feature('a'));
        UserDataScraperFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        UserDataScraperFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        UserDataScraperFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        UserDataScraperFeatureAdd::call($ctx, $replace);
        ...
        UserDataScraperFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UserDataScraperContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UserDataScraperSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UserDataScraperPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UserDataScraperPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UserDataScraperResponse(['headers' => null]),
            'result' => new UserDataScraperResult([]),
        ]);
        UserDataScraperResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UserDataScraperResultBody::call($ctx);
