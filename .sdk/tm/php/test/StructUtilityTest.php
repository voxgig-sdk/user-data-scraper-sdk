...
// UserDataScraper SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UserDataScraperOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UserDataScraperOmni::structfix($now, Struct::undef()))
                        !== json_encode(UserDataScraperOmni::structfix($val, Struct::undef()))) {
