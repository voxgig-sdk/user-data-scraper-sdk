...
// UserDataScraper SDK utility type

class UserDataScraperUtility
{
    ...
    public static function copy(UserDataScraperUtility $src): UserDataScraperUtility
    {
        $u = new UserDataScraperUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
