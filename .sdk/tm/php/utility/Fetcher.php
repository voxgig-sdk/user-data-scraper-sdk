...
// UserDataScraper SDK utility: fetcher

class UserDataScraperFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UserDataScraperSDK/1.0)';
    ...
    public static function call(UserDataScraperContext $ctx, string $fullurl, array $fetchdef): array
    {
