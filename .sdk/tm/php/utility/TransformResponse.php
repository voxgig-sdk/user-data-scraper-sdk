...
// UserDataScraper SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UserDataScraperTransformResponse
{
    public static function call(UserDataScraperContext $ctx): mixed
    {
        ...
        $transform = UserDataScraperHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
