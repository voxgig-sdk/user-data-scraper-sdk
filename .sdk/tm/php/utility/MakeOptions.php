...
// UserDataScraper SDK utility: make_options

class UserDataScraperMakeOptions
{
    ...
    public static function call(UserDataScraperContext $ctx): array
    {
        ...
        //
        // `UserDataScraperSchema::optspec()` is built from the model:
        ...
        $optspec = UserDataScraperSchema::optspec();
