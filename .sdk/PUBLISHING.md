...
|---|---|---|
| `ts/` | @voxgig-sdk/user-data-scraper-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/user-data-scraper-sdk \
      --repository voxgig-sdk/user-data-scraper-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/user-data-scraper-sdk` shows it, and
`npm trust revoke @voxgig-sdk/user-data-scraper-sdk --id=<id>` removes it.
