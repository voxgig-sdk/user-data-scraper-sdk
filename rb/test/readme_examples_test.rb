...
#      offline in seeded test mode (UserDataScraperSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UserDataScraper_sdk.rb")
  SDK_CLASS = "UserDataScraperSDK"
