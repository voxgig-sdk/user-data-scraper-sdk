...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/user-data-scraper` | `npm install @voxgig-sdk/user-data-scraper` |
| Python | `voxgig-sdk-user-data-scraper` | `pip install voxgig-sdk-user-data-scraper` |
| PHP | `voxgig-sdk/user-data-scraper` | `composer require voxgig-sdk/user-data-scraper` |
| Golang | `github.com/voxgig-sdk/user-data-scraper-sdk/go` | `go get github.com/voxgig-sdk/user-data-scraper-sdk/go` |
| Ruby | `voxgig-sdk-user-data-scraper` | `gem install voxgig-sdk-user-data-scraper` |
| Lua | `voxgig-sdk-user-data-scraper` | `luarocks install voxgig-sdk-user-data-scraper` |
