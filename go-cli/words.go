...
func registerSDKWords(r *eng.Registry, client *sdk.UserDataScraperSDK) {
...
func runOp(client *sdk.UserDataScraperSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
